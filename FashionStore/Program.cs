            ...
            .AddJwtBearer(options =>
            {
                ...
                options.Events = new JwtBearerEvents
                {
                    OnChallenge = context =>
                    {
                        ...
                        return context.Response.WriteAsync("{\"message\": \"Không có quy?n truy c?p ch?c n?ng này!\"}");
                    },
                    OnForbidden = context =>
                    {
                        context.Response.StatusCode = 403;
                        context.Response.ContentType = "application/json";
                        return context.Response.WriteAsync("{\"message\": \"B?n không có quy?n th?c hi?n hành ??ng này!\"}");
                    }
                };
            });
